      ...
      <section style={{ padding: "32px 0" }}>
        ...
        >
          ...
          >
            ...
            >
              {SKILL_DETAILS_MAP["Microsoft 365 & Windows"].map((skill, index) => (
                <a
                  key={index}
                  href={skill.href}
                  target="_blank"
          ...
          >
            ...
            >
              {SKILL_DETAILS_MAP.Networking.map((skill, index) => (
                <a
                  key={index}
                  href={skill.href}
                  target="_blank"
          ...
          >
            ...
            >
              {SKILL_DETAILS_MAP["Security & Operations"].map((skill, index) => (
                <a
                  key={index}
                  href={skill.href}
                  target="_blank"
          ...
          >
            ...
            >
              {SKILL_DETAILS_MAP["Systems & Cloud"].map((skill, index) => (
                <a
                  key={index}
                  href={skill.href}
                  target="_blank"
